...
const HomePage = () => {
  ...
  const handleAiSubmit = (e) => {
    e.preventDefault();
    if (aiQuestion.trim()) {
      navigate('/chatbot', { state: { initialQuestion: aiQuestion } });
    }
  };
  ...
  >
      ...
      <section style={{
        ...
        <div style={{
          ...
          {/* <FeatureCard
            ...
            isActive={activeFeature === 'Health Records'}
    ...
    <form className="contact-form" onSubmit={handleSubmit}>
      ...
      <div style={mobileNavBarStyle}>
        ...
        >
          <FiHome style={mobileNavIconStyle(activeMobileTab === 'home')} />
          Home
        </button>
        <button 
          style={mobileNavButtonStyle(activeMobileTab === 'profile')} 
          onClick={() => handleMobileNavClick('profile')}
        >
          <FiUser style={mobileNavIconStyle(activeMobileTab === 'profile')} />
          Profile
        </button>
        <button 
          style={mobileNavButtonStyle(activeMobileTab === 'appointments')} 
          onClick={() => handleMobileNavClick('appointments')}
        >
          <FiCalendar style={mobileNavIconStyle(activeMobileTab === 'appointments')} />
          Appointments
        </button>
        <button 
          style={mobileNavButtonStyle(activeMobileTab === 'chat')} 
          onClick={() => handleMobileNavClick('chat')}
        >
          <FiMessageSquare style={mobileNavIconStyle(activeMobileTab === 'chat')} />
          AI Chat
        </button>
        <button 
          style={mobileNavButtonStyle(activeMobileTab === 'Blog_page')} 
          onClick={() => handleMobileNavClick('Blog_page')}
        >
